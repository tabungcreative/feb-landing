			...
			<div className="container">
				<div className="row">
					<div className="col-lg-12 col-md-8 col-sm-4">
						...
						<p className="ms-3">“Menjadi Program Studi Perbankan Syari’ah yang menjunjung nilai-nilai Islam dan unggul dibidang Kewirausahaan pada Tahun 2031”.</p>
						<h5 className="mt-3">2. Misi</h5>
						<ol className="list-studi">
							<li>Menyelenggarakan pendidikan tinggi di bidang perbankan syari’ah untuk mengahasilkan sumber daya manusia yang handal, kreatif, dan inovatif yang dilandasi nilai-nilai Islami.</li>
							<li>
								Menyelenggarakan penelitian dan pengembangan ilmu pengetahuan dan teknologi khususnya di bidang ekonomi Islam untuk meningkatkan integritas kepribadian lulusan, menggabungkan jiwa kepemimpinan dan etika professional bidang
							...
							<li>Menyelenggarakan pengabdian kepada masyarakat yang memadukan ilmu ekonomi Islami dengan nilai-nilai Islami.</li>
							<li>Membangun tata kelola Program Studi yang baik untuk memperkuat sistem tata pamong yang transparan, akuntabel, dan berkualitas.</li>
						...
						<ol className="list-studi">
							...
							<li>Melaksanakan kegiatan pelayanan dan pengabdian kepada masyarakat di bidang ekonomi Islam.</li>
