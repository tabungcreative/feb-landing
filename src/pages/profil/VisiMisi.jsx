...
import img from "../../assets/images/banner/BANNER3.png";

const VisiMisi = () => {
	return (
		<>
			<Header />
			<Banner gambar={img} alt="gambar banner visi misi" />
			<div className="container mt-5">
				<div className="row">
					<div className="col-lg-12 col-md-8 col-sm-4">
						<h5 className="mt-3">1. Visi</h5>
						<p className="ms-3">“Menjadi Fakultas Ekonomi dan Bisnis yang menjunjung nilai-nilai Islam dan unggul dibidang Kewirausahaan pada Tahun 2031”.</p>
