...
const Sejarah = () => {
	return (
		<>
			<Header />
			<Banner gambar={img} alt="banner sejarah" />
							...
							<table className="table table-bordered ">
								<thead className="bg-light">
									<tr>
										<th>No</th>
										<th>Program Studi</th>
										<th>Status/Peringkat Akreditasi</th>
										<th>Nomor SK & Tanggal Ijin Penyelenggaraan</th>
										<th>Nomor SK & Tanggal Akreditasi BAN PT</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										...
										<td>Manajemen</td>
										<td>Akreditasi B</td>
										<td>1314/D/T/K-VI/2012</td>
										<td>2388/SK/BAN-PT/Akred/S/VII/2017</td>
									</tr>
									<tr>
										<td>2</td>
										<td>Akuntansi</td>
										<td>Akreditasi B</td>
										<td>13147/D/T/K-VI/2012</td>
										<td>026/BAN-PT/Ak-XIII/SI/VI/2016</td>
									</tr>
									<tr>
										<td>3</td>
										<td>Perbankan Syariah</td>
										<td>Akreditasi B</td>
										<td>"3656 Tahun 2014"</td>
										<td>1831/SK/BAN-PT/Akred/S/VII/2018</td>
									</tr>
								</tbody>
							</table>
						</div>
						<h5 className="h5 mt-5">C. Riwayat Kepemimpinan</h5>
						<div className="table-responsive">
